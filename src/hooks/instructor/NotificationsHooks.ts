...
import * as NotificationsService from 'api/instructor/NotificationsService';
import { Notification } from 'resources/instructor/Notification';

export const QUERY_KEY = 'instructor/notifications';
...
export function useNotifications(groupID: number) {
    return useQuery([QUERY_KEY], () => NotificationsService.index(groupID));
}
